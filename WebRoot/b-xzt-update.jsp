  	...
  	<body>
		...
		<section id="secondary_bar">
			...
			<div class="breadcrumbs_container">
				<article class="breadcrumbs"><a href="b-xzt.jsp">选择题管理</a> <div class="breadcrumb_divider"></div> <a class="current">更新选择题</a></article>
			</div>
		...
		<section id="main" class="column">
			...
			<article class="update-xzt-module">
				<form class="update-xzt-form" method="post" action="b-tkt.jsp">
		            <div class="control-group">
		              <label class="control-label" for=""><h4>选择题题目：</h4></label>
		              <div class="controls add-xzt-cke">
		                <textarea name="zxt-update-title" style="height: 500px" >
							请点击这里添加公告内容......
						</textarea>
		              </div>
		            </div>
		            <div class="control-group">
		              ...
		              <div class="controls">
		                <textarea name="xzt-update-answerA" style="height: 500px" >
							请点击这里添加公告内容......
						</textarea>
		              </div>
		            </div>
		            <div class="control-group">
		              ...
		              <div class="controls">
		                <textarea name="xzt-update-answerB" style="height: 500px" >
							请点击这里添加公告内容......
						</textarea>
		              </div>
		            </div>
		            <div class="control-group">
		              ...
		              <div class="controls">
		                <textarea name="xzt-update-answerC" style="height: 500px" >
							请点击这里添加公告内容......
						</textarea>
		              </div>
		            </div>
		            <div class="control-group">
		              ...
		              <div class="controls">
		                <textarea name="xzt-update-answerD" style="height: 500px" >
							请点击这里添加公告内容......
						</textarea>
		              </div>
		            </div>
		            ...
		            <div class="control-group">
		              ...
		              <div class="controls">
		                <select name="xzt-sub_type">					<%--   22种类型	--%>
		            ...
		            <button type="reset" class="btn" name="xzt-update-reset" id="xzt-update-reset">重填</button>
		            <a href="b-xzt.jsp"  class="btn" name="xzt-cancel" id="xzt-cancel">取消</a>
		          </form>
			</article>
		</section>
		
		<script>
			CKEDITOR.inline( 'zxt-update-title' );
			CKEDITOR.inline( 'xzt-update-answerA' );
			CKEDITOR.inline( 'xzt-update-answerB' );
			CKEDITOR.inline( 'xzt-update-answerC' );
			CKEDITOR.inline( 'xzt-update-answerD' );
		</script>
