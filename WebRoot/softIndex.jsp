		...
		<c:forEach items="${list.list}" var="i">
			<tr>
				...
				<td>
					...
					<a name="update-soft" class="btn" href="file/index2softUpdate?id=${i.id }">编辑</a>
	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span2 pull-left">
				<a name="add-soft" class="btn" href="file/index2softAdd">添加相关软件</a>
			</div>
			<div class="span8">
				<!--  <ul class="pager">
					<li>
						<a
							href="file/getSoftList?pageNow=${list.pageNumber == 1?1:list.pageNumber-1}">上一页</a>
					</li>
					<li>　第&nbsp${list.pageNumber }&nbsp页　 /　 共&nbsp${list.totalPage }&nbsp页　 </li>
					<li>
						<a
							href="file/getSoftList?pageNow=${list.pageNumber == list.totalPage?list.pageNumber:list.pageNumber+1}">下一页</a>
					</li>
				</ul>-->
				<center>
...
$(function(){
	...
	var address ='file/getSoftList?pageNow=';
