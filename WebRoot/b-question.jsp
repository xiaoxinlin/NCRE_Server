  	...
  	<body>
		...
		<section id="secondary_bar">
			...
			<div class="breadcrumbs_container">
				<article class="breadcrumbs"><a class="current">常见问题管理</a> <div class="breadcrumb_divider"></div> <%--<a class="current">Dashboard</a>--%></article>
			</div>
		...
		<section id="main" class="column">
			...
			<article class="module">
				<table class="table table-hover">
	              ...
	              <tbody>
	                <tr>
	                  <td>2015年什么什么什么是什么时候考试？</td>
	                  <td>现在，估计是上半年。</td>
	                  <td>
	                  	<a name="delete-question"  class="btn" href="">删除</button>
	                  	<a name="update-question"  class="btn" href="b-question-update.jsp">编辑</button>
	                  </td>
	                </tr>
	                <tr>
	                  <td>2015年什么什么什么是什么时候考试？</td>
	            ...
	            <div class="b-s-page">
					<div class="container-fluid">
						<div class="row-fluid">
							<div class="span2 pull-left"><a name="add-question"  class="btn" href="b-question-add.jsp">添加常见问题</a></div>
							<div class="span8">								
								<ul class="pager">
								  <li><a href="#">上一页</a></li>
								  <li><a href="#">下一页</a></li>
