  	...
  	<body>
		...
		<section id="secondary_bar">
			...
			<div class="breadcrumbs_container">
				<article class="breadcrumbs"><a class="current">相关软件管理</a> <div class="breadcrumb_divider"></div> <%--<a class="current">Dashboard</a>--%></article>
			</div>
		...
		<section id="main" class="column">
			...
			<article class="module">
				<table class="table table-hover">
	              ...
	              <tbody>
	                <tr>
	                  <td>快速查找软件2014.zip</td>
	                  <td>/file/soft/快速查找软件2014.zip</td>
	                  <td>2014-08-07</td>
	                  <td>
	                  	<a name="delete-soft"  class="btn" href="">删除</button>
	                  	<a name="update-soft"  class="btn" href="b-soft-update.jsp">编辑</button>
	                  </td>
	                </tr>
	                <tr>
	                  <td>快速查找软件2014.zip</td>
	            ...
	            <div class="b-s-page">
					<div class="container-fluid">
						<div class="row-fluid">
							<div class="span2 pull-left"><a name="add-soft"  class="btn" href="b-soft-add.jsp">添加相关软件</a></div>
							<div class="span8">								
								<ul class="pager">
								  <li><a href="#">上一页</a></li>
								  <li><a href="#">下一页</a></li>
