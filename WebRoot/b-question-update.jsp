  	...
  	<body>
		...
		<section id="secondary_bar">
			...
			<div class="breadcrumbs_container">
				<article class="breadcrumbs"><a href="b-question.jsp">常见问题管理</a> <div class="breadcrumb_divider"></div> <a class="current">更新常见问题</a></article>
			</div>
		...
		<section id="main" class="column">
			...
			<article class="update-question-module">
				<form class="update-question-form form-horizontal" method="post" action="b-question.jsp">
		            ...
		            <div class="control-group">
		              <div class="controls">
		                <button type="submit" class="btn" name="question-update" id="question-update">保存</button>
