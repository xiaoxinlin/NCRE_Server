			...
			<article class="module">
	            ...
	            <div class="b-s-page">
					<div class="container-fluid">
						<div class="row-fluid">
							<div class="span2 pull-left"><a name="add-anno"  class="btn" href="announcement/index2add">添加公告</a></div>
							<div class="span8">								
								<ul class="pager">
								  <li><a href="announcement/getAnnounList?pageNow=${annoList.pageNumber == 1?1:annoList.pageNumber-1}">上一页</a></li>
								  <li><a href="announcement/getAnnounList?pageNow=${annoList.pageNumber == annoList.totalPage?annoList.pageNumber:annoList.pageNumber+1}">下一页</a></li>
								</ul>	
							</div>
						</div>
					</div>
